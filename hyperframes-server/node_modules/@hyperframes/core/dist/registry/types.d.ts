...
export declare function isExampleItem(item: RegistryItem): item is ExampleItem;
export declare function isBlockItem(item: RegistryItem): item is BlockItem;
export declare function isComponentItem(item: RegistryItem): item is ComponentItem;
export {};
