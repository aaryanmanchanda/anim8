...
export function buildWaveformCacheKey(assetPath) {
...
export function decodeAudioPeaks(audioPath) {
...
export async function generateWaveformCache(projectDir, assetPath) {
