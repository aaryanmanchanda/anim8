...
import { VALID_CANVAS_RESOLUTIONS } from "../../core.types.js";
const VALID_RESOLUTIONS = new Set(VALID_CANVAS_RESOLUTIONS);
export function registerRenderRoutes(api, adapter) {
    ...
    const cleanupEnabled = () => typeof process !== "undefined" &&
    ...
    const ensureCleanupTimer = () => {
        if (cleanupTimer || !cleanupEnabled())
            return;
