 ...
 * @param timeoutMs - per-request timeout (default 8000ms)
 */
export async function lintScriptUrls(html, options = {}) {
        ...
        try {
            ...
            if (!resp.ok) {
                findings.push({
                    ...
                    fixHint: "This script URL is not accessible. Remove it or replace with a valid URL. The HyperFrames runtime is injected automatically — do not load it manually.",
                    snippet,
                });
            }
        }
